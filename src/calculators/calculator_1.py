...
class Calculator1:
    ...
    * A primeira parte é dividida por 4 e seu resultado somado a 7.
    Após isso, o resultado é elevado ao quadrado e multiplicado por um valor
    de 0.257.

    * A segunda parte é elevada a potência de 2.121, dividido por 5 e somado a 1

    * Terceira parte se mantem no mesmo valor

    * Por fim. é somado esses 3 valores e entrehue o resultado
